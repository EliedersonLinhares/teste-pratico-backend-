...
import com.esl.candidato.services.CandidatoServices;
...
public class CandidatoResource {
      ...
      @Autowired
      private CandidatoServices service;
      ...
      @ApiOperation(value="Insere um cadastro")
      @RequestMapping(method=RequestMethod.POST)
	public ResponseEntity<Void> insert(@Valid@RequestBody CandidatoNewDTO objDto){
      ...
      @ApiOperation(value="Apaga um cadastro por id")
    @PreAuthorize("hasAnyRole('ADMIN')")
      ...
      @ApiOperation(value="Busca por todos os cadastros")
    @PreAuthorize("hasAnyRole('ADMIN')")
      ...
      @ApiOperation(value="Busca por todos cadastros com paginação")
    @PreAuthorize("hasAnyRole('ADMIN')")
      ...
      @ApiOperation(value="Atualiza um cadastro por id")

...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.esl.candidato.Resource")).build().apiInfo(apiInfo());
    }

    private ApiInfo apiInfo() {
        return new ApiInfo("API para sistema de cadastro de candidatos a vagas",
                "Esta API é utilizada para estudos e desenvolvida com JAVA e SpringBoot", "Versão 1.0", "Apache 2.0",
                new Contact("Eliederson Linhares", "", "eliederson250@gmail.com"),
                "https://github.com/EliedersonLinhares", "", Collections.emptyList() // Vendor
                                                                                     // Extensions
        );
    }
